...
public class ClientHandler extends Thread {
    ...
    /**
     * Crea un manejador para un cliente conectado.
     *
    ...
    /**
     * Indica si el cliente está viendo reservaciones.
     *
     * @return true si está en la vista de reservaciones
     */
    ...
    /**
     * Obtiene el identificador del cliente logueado.
     *
    ...
    /**
     * Envía una respuesta interna al cliente.
     *
     * @param resp respuesta a enviar
     *
    ...
    /**
     * Ejecuta el hilo principal del cliente.
     */
    @Override
    public void run() {
    ...
    /**
     * Procesa una petición recibida del cliente.
     *
        ...
        try {
            ...
            switch (command.toUpperCase()) {
                ...
                case "DELETE_CLIENT":
                    ...
                    resp = ClientRequestHandler.handle(
                            command,
                            obj
                    );
                ...
                case "DELETE_ADMIN":
                    ...
                    resp = AdminRequestHandler.handle(
                            command,
                            obj
                    );
                ...
                case "GET_CALENDAR_BLOCKS":
                    ...
                    resp =
                            ReservationDraftRequestHandler
                                    .handle(
                                            command,
                                            obj
                                    );
                ...
                case "DELETE_AUDITORIUM_RESERVATIONS_BY_CLIENT_ID":
                    ...
                    resp =
                            AuditoriumReservationRequestHandler
                                    .handle(
                                            command,
                                            obj
                                    );
                ...
                case "ENTER_RESERVATIONS_VIEW":
                    ...
                    this.viewingReservations =
                            true;

                    resp = new Response(
                            true,
                            "Cliente registrado en "
                            + "vista de reservas",
                            null
                    );
                ...
                case "LOGIN":
                    ...
                    resp = UserRequestHandler.handle(
                            command,
                            obj
                    );
    ...
    /**
     * Imprime una respuesta en consola.
     *
