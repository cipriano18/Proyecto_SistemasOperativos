...
/**
 * Controlador encargado de gestionar las reservas temporales de equipos.
 *
 * <p>
 * Permite iniciar, actualizar, consultar, descartar y confirmar reservas
...
public class ReservationDraftController {
    ...
    /**
     * Obtiene los bloques del calendario de reservas.
     *
    ...
    public static Response getCalendarBlocks(
        ...
        /*
         * Solo se agregan los bloqueados
         * si existe un cliente válido.
         */
        if (idClient != null) {

            List<CalendarBlock> blocked
                    = EquipmentReservationDraftDAO
                            .getBlockedDraftsByMonth(
                                    month,
                                    year,
                                    idClient
                            );
    ...
    /**
     * Inicia una reserva temporal de equipos.
     *
     * @param request datos de la reserva temporal
    ...
    public static Response startEquipmentDraft(
        ...
        if (request == null) {
            return new Response(
                    false,
                    "La solicitud de la reserva temporal "
                    + "es obligatoria",
                    null
            );
        }
        ...
        EquipmentReservationDraft draft
                = EquipmentReservationDraftDAO.createDraft(
                        idClient,
                        reservation
                );
        ...
        if (draft == null) {
            return new Response(
                    false,
                    "Ya existe una reserva en proceso "
                    + "para esa fecha y sección, espere "
        ...
        return new Response(
                true,
                "Reserva temporal creada correctamente",
                draft
        );
    }

    /**
     * Actualiza una reserva temporal de equipos.
     *
    ...
    public static Response updateEquipmentDraft(
        ...
        if (request.getIdDraft() <= 0) {
            return new Response(
                    false,
                    "El id del draft es obligatorio",
                    null
            );
        }
        ...
        existingDraft.setEquipmentList(
                equipmentList
        );
    ...
    /**
     * Obtiene una reserva temporal por su identificador.
     *
     * @param idDraft identificador del draft
     * @return respuesta con la reserva temporal
     */
    public static Response getEquipmentDraftById(
            int idDraft
    ) {
        ...
        return new Response(
                true,
                "Reserva temporal obtenida correctamente",
                draft
        );
    }
     ...
     * @return respuesta con la reserva temporal
     */
    public static Response getEquipmentDraftByClientId(
            int idClient
    ) {
    ...
    /**
     * Descarta una reserva temporal de equipos.
     *
     * @param idDraft identificador del draft
     * @param idClient identificador del cliente
     * @return respuesta del proceso
    ...
    /**
     * Confirma una reserva temporal de equipos.
     *
     * @param idDraft identificador del draft
     * @param idClient identificador del cliente
     * @return respuesta del proceso
     */
    public static Response confirmEquipmentDraft(
            int idDraft,
            int idClient
    ) {
        ...
        if (draft.getEquipmentList() == null
                || draft.getEquipmentList().isEmpty()) {
        ...
        EquipmentReservationDraftDAO.deleteDraft(
                idDraft
        );
