...
/**
 * Gestiona las operaciones relacionadas con administradores.
 */
public class AdminDAO {
    ...
    /**
     * Obtiene un administrador mediante el id de usuario.
     *
    ...
    /**
     * Obtiene un administrador mediante su cédula.
     *
     * @param identityCard cédula del administrador
     *
     * @return administrador encontrado o null
     */
    public static Admin getAdminByIdentityCard(
            String identityCard
    ) {
    ...
    public static boolean updateAdmin(Admin admin) {
        ...
        if (
                Validator.isEmpty(admin.getfName())
                || Validator.isEmpty(admin.getfSurname())
        ) {
    ...
    /**
     * Obtiene un administrador con toda su información.
     *
     * @param idAdmin identificador del administrador
     *
     * @return administrador completo o null
     */
    public static AdminRequest getFullAdminById(
            int idAdmin
    ) {

        String sql = "SELECT a.id_admin, a.id_user, "
                + "a.f_name, a.m_name, "
                + "a.f_surname, a.m_surname, "
                + "a.identity_card, "
    ...
    /**
     * Elimina un administrador y sus relaciones.
     *
     * @param idAdmin identificador del administrador
     *
     * @return true si la eliminación fue exitosa
     */
    public static boolean deleteAdminCascade(
            int idAdmin
    ) {
        ...
        try {
            ...
            try (
                    ...
                    conn.prepareStatement(getAdminSql)
            ) {
            ...
            try (
                    PreparedStatement ps =
                    conn.prepareStatement(getContactsSql)
            ) {
