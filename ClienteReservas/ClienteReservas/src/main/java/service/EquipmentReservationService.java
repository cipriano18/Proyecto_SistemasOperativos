...
public class EquipmentReservationService {
    ...
    public static Response createEquipmentReservation(EquipmentReservationRequest request) {
        return sendRequest("CREATE_EQUIPMENT_RESERVATION", request);
    }
    ...
    public static Response getReservationById(int idReservation) {
        return sendRequest("GET_EQUIPMENT_RESERVATION_BY_ID", idReservation);
    }

    public static Response getReservationsByClientId(int idClient) {
        return sendRequest("GET_EQUIPMENT_RESERVATIONS_BY_CLIENT_ID", idClient);
    }

    public static Response deleteReservationById(int idReservation, int idClient) {
        int[] data = {idReservation, idClient};
        return sendRequest("DELETE_EQUIPMENT_RESERVATION_BY_ID", data);
    }

    public static Response deleteReservationsByClientId(int idClient) {
        return sendRequest("DELETE_EQUIPMENT_RESERVATIONS_BY_CLIENT_ID", idClient);
    }
